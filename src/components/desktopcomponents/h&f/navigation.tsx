    ...
    <div className="border-b border-bottom">
      ...
      <div className="lg:w-3/4 w-full max-w-6xl ml-auto mr-auto relative h-[50px]">
        <div className="absolute hidden p-1 pl-2 sm:block">
          <Link href="/">
            <img
              className="w-auto h-[43px] cursor-pointer "
              src="https://i.imgur.com/K5vhBw4.png"
            />
          </Link>
        </div>
        <div className="flex items-center justify-end h-full gap-2 text-sm text-[#616161]">
          ...
          <Link
            className="hover:bg-[#F0F0F0] hidden gap-2 h-full sm:flex items-center px-2"
            href="/news"
          >
            <Icon
          ...
          <hr className="h-10 w-[1px] bg-[#bbbbbb]" />
          {isLoggedIn && <div>MESSAGE ICON</div>}
